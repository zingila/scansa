...
1. **Remplacer les liens** dans `index.html`, `contact.html`, `privacy.html`, `terms.html` :
   ...
   <a href="https://play.google.com/store/apps/details?id=com.zingila.leaselens" class="store-button">
   ```

2. **Remplacer les liens CTA** dans `index.html` :
   ```html
   <a href="https://apps.apple.com/app/id6758580692" class="btn btn-primary">
   <a href="https://play.google.com/store/apps/details?id=com.zingila.leaselens" class="btn btn-secondary">
   ```
